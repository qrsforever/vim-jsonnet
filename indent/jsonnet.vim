" Source from vim/runtime/indent/json.vim
...
setlocal indentexpr=GetJSONNETIndent()
setlocal indentkeys=0{,0},0),0[,0],!^F,o,O,e

" Only define the function once.
if exists("*GetJSONNETIndent")
  finish
endif
...
" 3. GetJSONNETIndent Function {{{1
" =========================

function GetJSONNETIndent()
  " 3.1. Setup {{{2
  " ----------
